...
alias eescw='sudo ee site create $1 --wp'
alias eescwp7='eescw --php7' # WordPress site running with php7
alias eesch='sudo ee site create $1 --html'
alias eescp='sudo ee site create $1 --php'
alias eescp7='sudo ee site create $1 --php7' # create simple php7 site
alias eescm='sudo ee site create $1 --mysql' # create simple site and database
alias eescl='sudo ee site create $1 --letsencrypt'
alias eescwh='eescw --hhvm' # WordPress site running on hhvm

alias eescw3='sudo ee site create $1 --w3tc' # install wordpress with w3-total-cache plugin
alias eescws='sudo ee site create $1 --wpsc' # install wordpress with whisp-super-cache plugin
alias eescwf='sudo ee site create $1 --wpfc' # install wordpress + nginx fastcgi_cache
alias eescwr='sudo ee site create $1 --wpredis' # install wordpress + nginx redis_cache

alias eescwsdi='sudo ee site create $1 --wpsubdir' # install wpmu-subdirectory without any page caching
alias eescwsdir3='sudo ee site create $1 --wpsubdir --w3tc' # install wpmu-subdirectory with w3-total-cache plugin
alias eescwsdirs='sudo ee site create $1 --wpsubdir --wpsc' # install wpmu-subdirectory with wp-super-cache plugin
alias eescwsdirf='sudo ee site create $1 --wpsubdir --wpfc' # install wpmu-subdirectory + nginx fastcgi_cache
alias eescwsdirr='sudo ee site create $1 --wpsubdir --wpredis' # install wpmu-subdirectory + nginx redis_cache

alias eescwsdom='sudo ee site create $1 --wpsubdom' # install wpmu-subdomain without any page caching
alias eescwsdom3='sudo ee site create $1 --wpsubdom --w3tc' # install wpmu-subdomain with w3-total-cache plugin
alias eescwsdoms='sudo ee site create $1 --wpsubdom --wpsc' # install wpmu-subdomain with wp-super-cache plugin
alias eescwsdomf='sudo ee site create $1 --wpsubdom --wpfc' # install wpmu-subdomain + nginx fastcgi_cache
alias eescwsdomr='sudo ee site create $1 --wpsubdom --wpredis' # install wpmu-subdomain + nginx redis_cache
